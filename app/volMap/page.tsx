    ...
    <>
      ...
      <main className="max-w-5xl mx-auto p-10 text-center">
        ...
        <p className="text-black-600 text-lg ">
          Ovde možete pregledati i organizovati sve rute vezane za pružanje
          nege. Na jednom mestu pratite planirane posete, rute do klijenata i
          optimizujte svoje kretanje.
        </p>
        <p className="mt-4 text-black-500">
          Uskoro ćemo dodati interaktivnu mapu kako biste lakše pratili sve
          svoje obaveze.
        </p>
            ...
            <CardContent className="space-y-2 text-gray-700">
              <ul className="list-disc pl-5 space-y-1 text-left">
                {clients.map((client, index) => (
                  ...
                  >
                    {client.clientName} <PopUp {...client} />
                  </li>
                ))}
              </ul>
            </CardContent>
